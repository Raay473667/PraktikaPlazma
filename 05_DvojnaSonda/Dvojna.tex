...
\end{figure}
\newpage
Teplotu elektronů získáme ze vztahu
\begin{equation}
...
lze určit z rovnice
\begin{equation}
	n_\text{{p}} = \frac{4  _\text{{p}}}{S e \left\langle v_\text{{p}} \right\rangle }
	\label{ne}
\end{equation}
kde $S$ je plocha sondy a $\left\langle v{p} \right\rangle$ získáme jako
\begin{equation}
	\left\langle v_\text{{p}} \right\rangle = \left( \frac{8 k T_\text{{p}}}{\pi M} \right) 
	\label{vp}
\end{equation}
kde $T_\text{p}$ je teplota iontů a rovná se teplotě elektronů, $M$ je hmotnost iontu.
...
Všechny tři oblasti charakteristiky proložíme přímkou.
...
\begin{figure}[h!]
	...
	\caption{p = 8 \si{\pascal}, 55 \si{\milli\ampere}}
	\label{dvojna1}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{32 \si{\pascal}, 55 \si{\milli\ampere}}
	\label{dvojna2}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{160 \si{\pascal}, 55 \si{\milli\ampere}}
	\label{dvojna3}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{160 \si{\pascal}, 30 \si{\milli\ampere}}
	\label{dvojna4}
\end{figure}
