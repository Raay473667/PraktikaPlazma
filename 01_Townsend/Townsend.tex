...
\newpage
\section{Závěr}
Cílem této úlohy bylo seznámit se s Townsendovou teorií lavin. Z měření jsme ověřili exponenciální růst proudu s rostoucí vzdáleností elektrod. Také jsme určili první Townsendův koeficient pro různé hodnoty intenzity elektrického pole, který roste s rostoucí $E$. Nakonec jsme získali ionizační potenciál argonu ze závislostí $i = f(x)$ a $\text{ln}i = f(x)$ , který nám vyšel přesněji z lineárního proložení $\text{ln}i = f(x)$ jako $U_i$ = (14,50 $\pm$  2,38)\,eV , tabulková hodnota je $U_i = 15,76$\,eV.
