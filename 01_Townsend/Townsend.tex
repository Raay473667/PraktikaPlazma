...
tabulková hodnota je $U_i = 15,76$\,eV. V případě fitu exponenciální závislosti metodou nejmenších čtverců mají body o vyšší y hodnotě ve fitu větší váhu, než body při nízkých hodnotách. Výsledná proložená křivka je tedy nejvíce závislá na těchto bodech. Lineární fit bývá oproti exponenciálnímu přesnější.
