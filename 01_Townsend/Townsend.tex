...
V rovnicích (\ref{2}) a (\ref{3}) lze nahradit počet elektronů proudem. Z naměřených dat můžeme sestavit graf závislosti $i = i_0 f(x)$, viz obr. \ref{ifx}. Body jsou proložené exponenciální funkcí $i = i_0 e^{\alpha x}$. Získané $i_0$ a $\alpha$ z tohoto fitu jsou uvedené v tabulce %\ref{}.
