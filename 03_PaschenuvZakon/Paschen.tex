...
\begin{table}[h]
	...
	\begin{tabular}{|r|c|c|c|c|}
		...
		tlakem\end{tabular}               & 213 $\pm$ 2 & 5,75 $\pm$ 0,04 & 
		373 & 1,8 
		\\ \hline
		\begin{tabular}[c]{@{}r@{}}Měření s konstantní \\ vzdáleností 
		elektrod\end{tabular} & 148 $\pm$ 5 & 3,98 $\pm$ 0,13 & 367 & 2,5 
		\\ \hline
	Tabulkové hodnoty \cite{wiki,gamma}& 273,75 & 10,34 & 327 & 0,75 \\ \hline
\end{tabular}
\end{table}
\end{center}
...
\begin{figure}[h!]
	...
	\caption{Naměřená Paschenova křivka při konstantním tlaku $p = 100$\,Pa.}
	\label{tlakfixed}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption{Naměřená Paschenova křivka při konstantní vzdálenosti elektrod $d 
	= 20$\,mm.}
	\label{dfixed}
\end{figure}
...
výsledky se však pohybují ve stejném řádu $10^2$~V.
