...
Při měření vždy nejprve nalezneme plovoucí potenciál, abychom měli jistotu, že naměříme oblast nalevo i napravo od něj. Napětí přiložené na sondu $V_\text{S}$ se mění automaticky pomocí elektrického motorku který pohání potenciometr, stačí zařadit rychlostní stupeň v jednom
...
\newpage
Potenciál plazmatu $V_\text{p}$ přibližně určíme ze zlomu VA charakteristik jako průsečík asymptot k lineárním částem zlogaritmovaných závislostí. Postup je vidět na obrázcích \ref{data1} až \ref{data7} vlevo a výsledné $V_\text{p}$~jsou uvedeny v tab. \ref{tab1}. Vždy platí, že~$V_\text{p}$ je větší než $V_\text{fl}$. Stejně jako $V_\text{fl}$, potenciál plazmatu s~rostoucím výbojovým proudem roste, při změně
...
\begin{center}
	\begin{table}[h!]
		...
		\begin{tabular}{|c|c|c|c|c|c|} \hline
			...
			30 & -48,0 & -47,7 & 8 & -45,3 & -44,8\\ \hline
			40 & -43,8 & -43,4 & 16 & -45,8 & -45,2 \\ \hline
			50 & -42,2 & -41,6 & 32 & -45,0 & -44,6 \\ \hline
			&  &  & 80 & -44,4 & -43,9 \\ \hline
			& &  & 200 & -50,9 & -49,9 \\ \hline
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{.49\textwidth}
		...
		%\caption{$f(t) = \ln n$}
	\end{subfigure}
	\caption{Stanovení potenciálu plazmatu a elektronové teploty, $p = 160$ \si{\pascal} a $I_\text{v} = 30$ \si{\milli\ampere}.}
	\label{data1}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{.49\textwidth}
		...
		%\caption{$f(t) = \ln n$}
	\end{subfigure}
	\caption{Stanovení potenciálu plazmatu a elektronové teploty, $p = 160$ \si{\pascal} a $I_\text{v} = 40$ \si{\milli\ampere}.}
	\label{data0}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{.49\textwidth}
		...
		%\caption{$f(t) = \ln n$}
	\end{subfigure}
	\caption{Stanovení potenciálu plazmatu a elektronové teploty, $p = 160$ \si{\pascal} a $I_\text{v} = 50$ \si{\milli\ampere}.}
	\label{data2}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{.49\textwidth}
		...
		%\caption{$f(t) = \ln n$}
	\end{subfigure}
	\caption{Stanovení potenciálu plazmatu a elektronové teploty, $p = 320$ \si{\pascal} a $I_\text{v} = 40$ \si{\milli\ampere}.}
	\label{data3}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{.49\textwidth}
		...
		%\caption{$f(t) = \ln n$}
	\end{subfigure}
	\caption{Stanovení potenciálu plazmatu a elektronové teploty, $p = 80$ \si{\pascal} a $I_\text{v} = 40$ \si{\milli\ampere}.}
	\label{data4}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{.49\textwidth}
		...
		%\caption{$f(t) = \ln n$}
	\end{subfigure}
	\caption{Stanovení potenciálu plazmatu a elektronové teploty, $p = 32$ \si{\pascal} a $I_\text{v} = 40$ \si{\milli\ampere}.}
	\label{data5}
\end{figure}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{.49\textwidth}
		...
		%\caption{$f(t) = \ln n$}
	\end{subfigure}
	\caption{Stanovení potenciálu plazmatu a elektronové teploty, $p = 16$ \si{\pascal} a $I_\text{v} = 40$ \si{\milli\ampere}.}
	\label{data6}
\end{figure}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{.49\textwidth}
		...
		%\caption{$f(t) = \ln n$}
	\end{subfigure}
	\caption{Stanovení potenciálu plazmatu a elektronové teploty, $p = 8$ \si{\pascal} a $I_\text{v} = 40$ \si{\milli\ampere}.}
	\label{data7}
\end{figure}
...
\begin{thebibliography}{widest entry}
	\bibitem{VA} Návod k praktiku: Diagnostika plazmatu doutnavého výboje pomocí elektrostatických sond: jednoduchá sonda.
