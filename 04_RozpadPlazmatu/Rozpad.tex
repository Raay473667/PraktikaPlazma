...
Závislosti $1/n = f(t)$ a $\ln n = f(t)$ včetně proložení podle rovnice 
\eqref{zpresnena} jsou na obrázcích~\ref{g:5Pa}-\ref{g:450Pa}. Koeficienty 
$\alpha$ a $D$ určené z proložených lineárních a exponenciálních funkcí jsou 
uvedeny v tab.~\ref{table:koef}
